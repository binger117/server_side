...
class GoodsGroup(models.Model):
    ...
    image = models.ImageField(blank=True, null=True, verbose_name='分类图标')
...
class Goods(BaseModel):
    ...
    title = models.CharField(verbose_name='标题', help_text='标题', max_length=10, default='')
    desc = models.CharField(verbose_name='商品描述', help_text='商品描述', max_length=20)
