...
INSERT INTO `cart` VALUES (2,'2023-07-06 08:11:16.384945','2023-07-06 08:11:16.384945',0,1,1,1,1),(3,'2023-07-06 08:11:26.647339','2023-07-06 08:11:26.647339',0,2,1,2,1);
...
INSERT INTO `collect` VALUES (2,2,2),(3,1,2);
...
CREATE TABLE `comment` (
  ...
  `user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `comment_goods_id_05aaddda_fk_goods_id` (`goods_id`),
  KEY `comment_order_id_c2e30380_fk_order_id` (`order_id`),
  KEY `comment_user_id_2224f9d1_fk_users_id` (`user_id`),
  CONSTRAINT `comment_goods_id_05aaddda_fk_goods_id` FOREIGN KEY (`goods_id`) REFERENCES `goods` (`id`),
  CONSTRAINT `comment_order_id_c2e30380_fk_order_id` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`),
...
INSERT INTO `comment` VALUES (20,'2023-07-08 09:29:32.869639','2023-07-08 09:29:32.869639',0,'孩子很喜欢',1,5,1,2,2),(21,'2023-07-08 09:29:32.873629','2023-07-08 09:29:32.873629',0,'孩子太喜欢了',1,5,2,2,2);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(15,'cart','cart'),(4,'contenttypes','contenttype'),(14,'goods','collect'),(11,'goods','detail'),(13,'goods','goods'),(10,'goods','goodsbanner'),(12,'goods','goodsgroup'),(18,'order','comment'),(16,'order','order'),(17,'order','ordergoods'),(5,'sessions','session'),(9,'users','addr'),(7,'users','area'),(6,'users','user'),(8,'users','verifcode');
...
INSERT INTO `django_session` VALUES ('hn414lrt1uis2w3wru6qy1dc8p6mxip9','.eJxVy00KwjAQQOG7ZC2lSTOTiUv3niHM5IcUaQo2XYh4dy240O37eE8VeO817Fu-hzmpswJ1-m3C8ZbbAXFdlrUNB-XW58g9D9fH5et_U-Wtfg5HHk2x6N1UNIjR6CkKCfEIEQUcERmrk0VJ2nBBkx2MDs0kQKBFvd7u2zJP:1qA5bN:tH_0bQke3Cqi_YdEmt5p-OUp3wotf0f-4CZa_5w6lT4','2023-06-30 09:18:41.827794'),('rh7u14nkvsgn310o3l2eyfqodpvfwjrh','.eJxVy00KwjAQQOG7ZC2lSTOTiUv3niHM5IcUaQo2XYh4dy240O37eE8VeO817Fu-hzmpswJ1-m3C8ZbbAXFdlrUNB-XW58g9D9fH5et_U-Wtfg5HHk2x6N1UNIjR6CkKCfEIEQUcERmrk0VJ2nBBkx2MDs0kQKBFvd7u2zJP:1qFtHP:PFOm8trVqn0BNYqiLS2fwxJZMCtb5MmAoY6kq5_4N2g','2023-07-16 09:22:03.688982'),('saajxxjo6gpmwmmn2wvagaiwdewhxojy','.eJxVy00KwjAQQOG7ZC2lSTOTiUv3niHM5IcUaQo2XYh4dy240O37eE8VeO817Fu-hzmpswJ1-m3C8ZbbAXFdlrUNB-XW58g9D9fH5et_U-Wtfg5HHk2x6N1UNIjR6CkKCfEIEQUcERmrk0VJ2nBBkx2MDs0kQKBFvd7u2zJP:1qI3Er:5nVoRGby0599X5A78ceVXwOv13bP8gOcFKEYz47yzZg','2023-07-22 08:24:21.534554');
...
INSERT INTO `goods` VALUES (1,'2023-06-17 03:08:13.815209','2023-07-08 09:27:29.041706',0,'苹果','大凉山苹果',2.00,'goods01.jpg',997,90,1,1,1),(2,'2023-06-17 03:11:32.405718','2023-07-09 09:12:57.521065',0,'香蕉','特产香蕉',5.00,'goods02.jpg',995,13,0,1,1),(3,'2023-06-17 07:59:59.813808','2023-07-09 09:12:57.530042',0,'秋刀鱼','神户秋刀鱼',999.00,'goods03.jpg',995,81,1,1,3),(4,'2023-06-17 08:02:33.152266','2023-06-18 09:10:44.051779',0,'五花肉一斤','新鲜五花肉',15.00,'goods04.jpg',99,99,1,1,2),(5,'2023-06-18 09:15:13.645630','2023-06-18 09:15:13.645630',0,'龙虾','神户龙虾',65.00,'goods05.jpg',999,55,1,1,3);
...
INSERT INTO `order` VALUES (1,'2023-07-07 09:34:59.386769','2023-07-08 09:25:04.692881',0,'河南省商丘市华邑城小区guess117  斌戈尔117   18436099538','16887224992',1998,5,1,NULL,NULL,2),(2,'2023-07-08 09:27:29.037717','2023-07-08 09:29:32.875642',0,'河南省商丘市华邑城小区guess117  斌戈尔117   18436099538','16888084492',14,5,1,NULL,NULL,2),(3,'2023-07-09 09:12:57.518073','2023-07-10 07:18:13.028798',0,'河南省商丘市华邑城小区guess117  斌戈尔117   18436099538','16888939780',2008,2,1,'2023-07-10 03:20:23.000000','2023071022001445540500358423',2);
...
CREATE TABLE `ordergoods` (
  ...
  `order_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `orderGoods_goods_id_c310839c_fk_goods_id` (`goods_id`),
  KEY `orderGoods_order_id_674e0f92_fk_order_id` (`order_id`),
  CONSTRAINT `orderGoods_goods_id_c310839c_fk_goods_id` FOREIGN KEY (`goods_id`) REFERENCES `goods` (`id`),
  CONSTRAINT `orderGoods_order_id_674e0f92_fk_order_id` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ordergoods` VALUES (1,'2023-07-07 09:34:59.393749','2023-07-07 09:34:59.393749',0,999,2,3,1),(2,'2023-07-08 09:27:29.043702','2023-07-08 09:27:29.043702',0,2,2,1,2),(3,'2023-07-08 09:27:29.046693','2023-07-08 09:27:29.047692',0,5,2,2,2),(4,'2023-07-09 09:12:57.526052','2023-07-09 09:12:57.526052',0,5,2,2,3),(5,'2023-07-09 09:12:57.530042','2023-07-09 09:12:57.530042',0,999,2,3,3);
...
-- Dump completed on 2023-07-10 15:20:35
